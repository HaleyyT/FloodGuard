...
def write_model_card(results: list[dict]) -> None:
    ...
    lines = [
        ...
        f"- Joined placeholder-evidence event windows: {labels_summary.get('placeholderEvidenceRows', 0)}",
        f"- Joined evidence support status counts: {labels_summary.get('evidenceSupportStatusCounts', {})}",
        ...
        f"- Backlog placeholder-evidence rows: {backlog_summary.get('placeholderEvidenceRows', 0)}",
        f"- Backlog evidence support status counts: {backlog_summary.get('evidenceSupportStatusCounts', {})}",
