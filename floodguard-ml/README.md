...
4. Review outputs in `floodguard-ml/reports/` and `floodguard-ml/models/`, especially `validation_summary.md`, `calibration_summary.md`, `model_card.md`, and the dataset-specific metrics files.
